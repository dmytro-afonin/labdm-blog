...
- For contributors who do not use Obsidian, `README.md`, `docs/`, and `CONTRIBUTING.md` remain the primary developer docs; start at `obsidian-docs/00-Index.md` for the same material in vault form.
